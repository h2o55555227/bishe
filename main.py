...
def main():
    ...
    if os.path.exists(model_path):
        ...
        model = build_transformer_model((sequence_length, input_feature_count), activation="swish", projection_dim=128, num_heads=4, ff_dim=512, num_transformer_blocks=3, dropout_rate=0.05, patch_size=6)
        print("模型构建完成。")
        print("模型摘要:")
        model.summary()
    print()
